...
if df is not None and modelo_ann is not None:
    ...
    # --- C. RESTRICCIÓN HÍDRICA (BALCARCE: SIGMOIDE + RELAJACIÓN DINÁMICA) ---
    ...
    # Relajación dinámica:
    # - si en 21 días supera 50 mm, se libera el bloqueo de seguridad
    ...
    # 🌧️ NUEVA REGLA vK4.4: Forzar pico de 1.0 frente a eventos de lluvia >= 30 mm
